  ...
  let s:guishade0 = "#343637"
  let s:guishade1 = "#495a64"
  let s:guishade2 = "#556873"
  let s:guishade3 = "#8fabbd"
  let s:guishade4 = "#899ba6"
  let s:guishade5 = "#a7b8c2"
  let s:guishade6 = "#cae2f2"
  let s:guishade7 = "#f2f2f2"
  let s:guiaccent0 = "#e66565"
  let s:guiaccent1 = "#f2c38f"
  let s:guiaccent2 = "#fffa70"
  let s:guiaccent3 = "#92dd69"
  let s:guiaccent4 = "#7fc1ca"
  let s:guiaccent5 = "#83afe5"
  let s:guiaccent6 = "#ff944d"
  let s:guiaccent7 = "#ff8ab3"
  let s:ctermshade0 = 59
  let s:ctermshade1 = 240
  let s:ctermshade2 = 102
  let s:ctermshade3 = 146
  let s:ctermshade4 = 145
  let s:ctermshade5 = 249
  let s:ctermshade6 = 189
